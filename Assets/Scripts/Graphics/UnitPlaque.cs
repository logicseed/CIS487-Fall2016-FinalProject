...
public class UnitPlaque : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        healthBar.sizeDelta = new Vector2(4.0f * ((float)agent.health / agent.maximumHealth), 0.25f);
        shieldsBar.sizeDelta = new Vector2(4.0f * ((float)agent.shields / agent.maximumShields), 0.25f);
